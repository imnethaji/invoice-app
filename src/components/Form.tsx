...
const Form = forwardRef<HTMLDialogElement, FormDataRefProps>(function Form(
  props,
  ref
) {
  ...
  return (
    <dialog
      ref={ref || dialogRef}
      className="flex bg-[#10111d] p-10 backdrop-brightness-50"
    >
      <form className="w-[600px] mb-10" onSubmit={handleSubmit}>
